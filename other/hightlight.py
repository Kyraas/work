...
# https://learndataanalysis.org/highlighting-specific-line-in-a-text-editor-pyqt5-tutorial/
...
class HighlightDelegate(QtWidgets.QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        style.drawControl(options.text, options, painter)
    ...
    def apply_highlight(self):
        ...
        fmt.setForeground(QtGui.QColor('#ff7f7f'))
