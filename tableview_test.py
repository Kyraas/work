...
"border-color: rgb(0, 0, 0);")
        ...
        self.horizontalLayout_2.addWidget(self.lblCount)
        self.btnNext = QtWidgets.QPushButton(self.centralwidget)
        self.btnNext.setMinimumSize(QtCore.QSize(0, 30))
        self.btnNext.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnNext.setText(_translate("MainWindow", "Вперёд"))
